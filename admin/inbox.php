...
$to_id = "admin";
$sql = "SELECT *, DATE_FORMAT(date_sent, '%b %e, %Y %H:%i:%s') AS date_sent FROM admin_inbox WHERE to_id='$to_id' ORDER BY id DESC LIMIT $offset, $rowsPerPage";
$result = mysqli_query($db, $sql);

// Get the total number of rows for pagination
$totalRows = mysqli_num_rows(mysqli_query($db, "SELECT * FROM admin_inbox WHERE to_id='$to_id'"));
        ...
        <div class="info">
            <div class="container my-5" style="text-align: center;">
                ...
                <form action="deleteMessage" method="post">
                    ...
                    <h1 style="color: #ffffff;text-align: center;padding: 10px"> Admin Inbox</h1>
                    ...
                    <button type="submit" class="btn btn-danger" style="margin-top: 5px;margin-bottom: 5px; margin-left:1px"><i class="fas fa-trash-alt"></i></button>
                        ...
                        <table class="table table-hover shadow">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<td><a href="userProfile.php?id=' . $row['from_id'] . '" class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">' . $row['from_name'] . '</a></td>';
